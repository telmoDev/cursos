...
<div class="block mt-2 p-2">
    ...
    @forelse ($citas as $cita)
        <div class="hover:border-2 hover:border-[#6b2b83] p-2 mt-2 border">
            ...
            <div class="flex mt-2">
                <div class="rounded-lg bg-red-600 p-2" title="Eliminar Cita" onclick="confirm('Esta seguro que desea eliminar esta cita.') || event.stopImmediatePropagation()"
                    wire:click="borrarCita({{ $cita['id'] }})">
